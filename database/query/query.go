...
var (
	...
	FindOAuthProviderById                        = "SELECT * FROM OAuthProviders WHERE Id = ?"
	FindOAuthProviderByProviderNameAndProviderId = "SELECT * FROM OAuthProviders WHERE ProviderName = ? AND ProviderId = ?"
	// Gets array of OAuthProviders
	FindOAuthProviderByUserId  = "SELECT * FROM OAuthProviders WHERE UserId = ?"
	...
	CreateOAuthProvider = "INSERT INTO OAuthProviders (Id, ProviderName, ProviderId, Principal, Token, UserId) VALUES (?, ?, ?, ?, ?, ?)"
	...
	DeleteOAuthProviderById = "DELETE FROM OAuthProviders WHERE Id = ?"
