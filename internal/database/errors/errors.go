...
var (
	...
	ErrEmailAlreadySetAsPrimary   = errors.New("email is already set as primary")
	...
	ErrUserPictureAlreadyExists   = errors.New("user picture already exists")
	ErrProviderAlreadyExists      = errors.New("provider already exists")
	ErrPictureAlreadySetAsPrimary = errors.New("picture is already set as primary")
)
